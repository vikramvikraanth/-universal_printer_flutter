...
enum PrinterMessages {
    ...
    static func userMessage(_ reason: String) -> String {
        ...
        case "PAPER_JAM": return "Paper is jammed. Clear the jam and try again."
        case "OVERHEATED": return "The printer is overheating. Let it cool for a minute and try again."
        case "HOLDING_PAPER": return "Please remove the printed receipt, then try again."
